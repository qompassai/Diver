--- vscode-json-language-server language-server config — starts the JSON files tutor.
---
...
--- card that tells Neovim how to start the `vscode-json-language-server` tutor whenever you open JSON files. It
--- only takes effect if `vscode-json-language-server` is installed on your computer. It also wires in SchemaStore
--- so known JSON formats get schemas automatically.
---@module 'lsp.json_ls'
            ...
            schemas = {
                {
                    ...
                    url = 'https://raw.githubusercontent.com/angular/angular-cli/'
                        .. 'master/packages/angular/cli/lib/config/workspace-schema.json',
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/angular/'
                        .. 'angular-cli/v10.1.6/packages/angular/cli/lib/config/schema.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/microsoft/azure-pipelines-vscode/'
                        .. 'master/service-schema.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/conda-forge/conda-smithy/main/'
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/'
                        .. 'streetsidesoftware/cspell/main/packages/cspell-types/cspell.schema.json',
                },
                {
                ...
                },
                {
                    ...
                    fileMatch = { 'CVE-*.json' },
                    url = 'https://raw.githubusercontent.com/CVEProject/'
                        .. 'cve-schema/master/schema/docs/CVE_Record_Format_bundled.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/dbt-labs/'
                        .. 'dbt-jsonschema/main/schemas/latest/dependencies-latest.json',
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/dbt-labs/dbt-jsonschema/main/schemas/'
                        .. 'latest/dbt_project-latest.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/dbt-labs/'
                        .. 'dbt-jsonschema/main/schemas/latest/dbt_yml_files-latest.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/firebase/firebase-tools/master/schema/'
                ...
                },
                {
                    ...
                    url = '"https://raw.githubusercontent.com/google-gemini/'
                        .. 'gemini-cli/refs/heads/main/schemas/settings.schema.json',
                },
                {
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/helm-unittest/'
                        .. 'helm-unittest/refs/heads/main/schema/helm-testsuite.json',
                },
                {
                    ...
                    url = 'https://github.com/cmhughes/latexindent.pl/raw/main/documentation/'
                ...
                },
                {
                    ...
                    url = 'https://raw.githubusercontent.com/microsoft/vcpkg-tool/main/docs/'
