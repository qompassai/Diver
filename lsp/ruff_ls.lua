...
-- -------------------------------------------------
-- Reference: https://docs.astral.sh/ruff/editors/features/#code-actions
--
...
return ---@type vim.lsp.Config
{
  ...
  on_attach = function(client, bufnr)
    ...
    vim.api.nvim_buf_create_user_command(bufnr, 'RuffQuickFix', function()
      ruff_action(bufnr, 'quickfix')
    end, {
      desc = 'Ruff: apply quick fix / noqa suppression for the diagnostic under the cursor',
    })
