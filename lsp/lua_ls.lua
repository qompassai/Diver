        ...
        Lua = {
            ...
            format = { ---@source https://luals.github.io/wiki/settings/#format
                ...
                defaultConfig = {
                    ...
                    line_space_after_expression_statement = 'none',
                    line_space_after_for_statement = 'none',
                    line_space_after_function_statement = 'fixed(2)',
                    line_space_after_if_statement = 'none',
                    line_space_after_local_or_assign_statement = 'none',
                    line_space_after_repeat_statement = 'none',
                    line_space_after_while_statement = 'none',
                    ...
                    space_before_inline_comment = 'none',
