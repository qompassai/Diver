...
local function on_init_sln(client, target)
  vim.notify('Initializing: ' .. target, vim.log.levels.TRACE, { title = 'roslyn_ls' }) ---@diagnostic disable-next-line: param-type-mismatch
...
local function on_init_project(client, project_files)
  ...
  client:notify('project/open', {
    projects = vim.tbl_map(function(file) ---@param file string
