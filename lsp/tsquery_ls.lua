...
local data_directory = fn.stdpath('data')
local home_directory = fn.expand('~')
...
return ---@type vim.lsp.Config
{
  ...
  settings = { ---@source https://github.com/ribru17/ts_query_ls
    parser_install_directories = {
      fs.joinpath(data_directory, 'site', 'parser'),
      fs.joinpath(data_directory, 'lazy', 'nvim-treesitter', 'parser'),
      fs.joinpath(data_directory, 'site', 'pack', 'core', 'opt', 'nvim-treesitter', 'parser'),
      fs.joinpath(home_directory, '.local', 'lib', 'nvim', 'parser'),
    },
    diagnostic_options = {
