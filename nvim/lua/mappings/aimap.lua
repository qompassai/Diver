    ...
    vim.api.nvim_create_autocmd('LspAttach', {
        callback = function(ev)
            ...
            map(
                ...
                ':RoseContext<CR>',
                vim.tbl_extend('force', opts, {
                    desc = 'Rose Edit local context file',
            ...
            map(
                ...
                ':RosePrepend<CR>',
                vim.tbl_extend('force', opts, {
                    desc = 'Rose Prepend to selection',
