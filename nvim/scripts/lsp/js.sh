...
pnpm add -g \
  ...
  sap/cds-lsp@latest \
  sf-agentscript/lsp-server@latest \
  sf-agentscript/agentforce-dialect@latest \
  sf-agentscript/agentscript-dialect@latest \
  sf-agentscript/language@latest \
  sf-agentscript/parser-tree-sitter@latest \
  sf-agentscript/types@latest \
