...
-- --------------------------------------------------
--
-- Plugin-free modernization of vim-dadbod's autoload/db/adapter.vim for
-- Neovim 0.13+. Works alongside lua/config/data/init.lua.
--
...
M.state = {
        ---@type table<string, QompassDbAdapter>
        adapters = {},
