...
---Check whether a client supports an LSP method for a buffer.
---
---Plain-language version: ask the language client "can you do this here?";
---features are only turned on when the server says yes.
