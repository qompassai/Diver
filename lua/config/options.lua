...
vim.opt.exrc = true
vim.opt.fileformats = { "unix", "dos", "mac" }  -- No comma here
vim.opt.fileencodings = { "utf-8", "ucs-bom", "default", "latin1" }  -- No comma here
vim.opt.fileencoding = "utf-8"  -- No comma here
