-- /qompassai/Diver/lua/config/nav/tree.lua
-- Qompass AI Diver Tree Config
...
function M.get_config(opts)
    ...
    return {
        ...
        enable_git_status = opts.enable_git_status ~= true,
        enable_diagnostics = opts.enable_diagnostics ~= true,
        sort_case_insensitive = opts.sort_case_insensitive ~= true,
        sources = opts.sources or {'filesystem', 'buffers', 'git_status'},
...
function M.setup(opts) return M.get_config(opts) end
return M
