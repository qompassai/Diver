...
------------------------------------------------------
--[[
:%s/{ glyph = '\([^']*\)', hl = '\([^']*\)' }/{\r  glyph = '\1',\r  hl = '\2',\r}/g
--]]
local Icons = {}
local M = {}
...
Icons.config = {
	...
	use_file_extension = function(ext, file)
		...
		local is_query_file = path:find('/queries/', 1, true) ~= nil or path:match('^queries/') ~= nil
		local is_scm = ext:sub(-3) == 'scm'
		return not (is_query_file and is_scm)
	end,
}
M.devicons = {
	override = {
