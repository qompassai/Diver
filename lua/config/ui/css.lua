...
function M.css_nls()
    return {
        ...
        }), b.diagnostics.stylelint.with({ft = {'css', 'scss', 'less'}}),
        b.formatting.stylelint.with({ft = {'css', 'scss', 'less'}}),
...
function M.css_lsp(on_attach, capabilities)
    ...
    lspconfig.tailwindcss.setup({
        ...
        ft = {
            ...
            'django-html', 'htmldjango', 'edge', 'eelixir', 'ejs', 'erb',
            'eruby', 'gohtml', 'handlebars', 'hbs', 'html', 'htmlangular',
            'html-eex', 'heex', 'liquid', 'markdown', 'mdx', 'mustache', 'njk',
            'php', 'razor', 'slim', 'twig', 'css', 'less', 'postcss', 'sass',
            'scss', 'stylus', 'javascript', 'javascriptreact', 'typescript',
        ...
        on_new_config = function(new_config)
            ...
            if not new_config.settings.editor.tabSize then
                new_config.settings.editor.tabSize = vim.lsp.util
        ...
        root_dir = function(fname)
            ...
            root_file =
                util.insert_package_json(root_file, 'tailwindcss', fname)
