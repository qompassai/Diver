...
function M.setup_highlights()
    vim.schedule(function()
        ...
        set_hls({
            ...
            ['@conditional'] = { fg = '#bb9af7', bold = true },
            ['@constant'] = { fg = '#ff9e64' },
            ...
            ['@function.macro'] = { fg = '#7aa2f7', bold = true },
            ['@include'] = { fg = '#bb9af7', bold = true },
            ...
            TabLineSel = { fg = '#c0caf5', bg = '#1f2335', bold = true },
