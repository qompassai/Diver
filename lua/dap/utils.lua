...
function M.splitstr(value)
    ...
    ---@param accumulator string folded words so far
    ---@param part string next word to append
    ---@return string new folded value
    local function fold(accumulator, part)
        return accumulator .. part
    end
    local element = lpeg.Cf(word ^ 1, fold)
