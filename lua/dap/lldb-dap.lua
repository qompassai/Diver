    ...
    if not cached_adapter_command then
        notify(
            'lldb-dap was not found. On Arch Linux install the lldb '
                .. 'package; otherwise set NVIM_LLDB_DAP or vim.g.lldb_dap_path',
            vim.log.levels.ERROR
        )
        return nil
    end
...
---Launch the program under the LLDB debugger.
---@return nil
function M.launch()
...
---Launch the program, stopping at the entry point.
---@return nil
...
---Attach the debugger to a running process (picker).
---@return nil
...
---Attach the debugger to a process by PID.
---@return nil
...
---Attach the debugger to a program by name.
---@return nil
...
---Wait for a program to appear, then attach.
---@return nil
...
---Open a core dump in the debugger.
---@return nil
...
---Attach the debugger to a remote lldb-server.
---@return nil
