  ...
  parse_chunk_loop = function()
    ...
    while true do
      ...
      if header_end then
        ...
        buffer = rest .. (coroutine.yield(body) or error('Expected more data for the body. The server may have died.'))
      else
        buffer = buffer .. (coroutine.yield() or error('Expected more data for the header. The server may have died.'))
      end
    end
  end
end
