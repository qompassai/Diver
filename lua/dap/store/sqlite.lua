...
]]):format(common.literal(project.id), common.literal(project.root))
...
SET ended_at = CURRENT_TIMESTAMP,
    ...
    result = %s
WHERE id = %s;
]]):format(common.literal(outcome.exit_code), common.literal(outcome.result), common.literal(session_id))
...
VALUES (%s, %s, %s);
]]):format(common.literal(event.session_id), common.literal(event.event_type), common.json(event.payload))
