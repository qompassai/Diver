--- editorconfig-checker linter adapter — .editorconfig rule checker wiring.
---
--- Plain-language version: a linter is like a spell-checker, but for code instead of words. This file teaches
--- Neovim how to run the `editorconfig-checker` program and turn its complaints into squiggles under your code. It
--- only runs when linting is triggered (usually on save), and only if `editorconfig-checker` is installed on your
--- computer.
---@module 'linters.editorconfig_checker'
-- #################################################################
