...
local function parse(output, context)
  ...
  if foreign then
    append_status(diagnostics, status(context, 'other-files', 'Conftest returned results for a different input file.'))
  end

  if malformed then
    append_status(diagnostics, status(context, 'malformed-result', 'Some Conftest results were malformed and omitted.'))
  end
