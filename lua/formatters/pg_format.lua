...
assert(CONFIG.width > 0 and CONFIG.width <= 1000, 'pg_format: width must be within 1..1000 columns')
assert(CONFIG.indent > 0 and CONFIG.indent <= 16, 'pg_format: indent must be within 1..16 spaces')
