-- /qompassai/Diver/lua/ai/rose/provider/qompass.lua
-- Qompass legacy provider class (Tiger Style)
...
function Rose:get_available_models()
    ...
    local parsed_response = utils.parse_raw_response(curl_tags())
