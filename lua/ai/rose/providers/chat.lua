-- /qompassai/Diver/lua/ai/rose/providers/chat.lua
-- OpenAI-compatible chat completions encode/decode (Tiger Style)
...
function M.decode(config, response)
    ...
    assert(not C.present(message.function_call), 'legacy function_call is unsupported; use modern tools')
