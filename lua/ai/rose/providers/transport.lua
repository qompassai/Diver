-- /qompassai/Diver/lua/ai/rose/providers/transport.lua
-- Authenticated cloud transport over curl with a stdin config (Tiger Style)
-- Copyright (C) 2025 Qompass AI, All rights reserved
-- ----------------------------------------
-- Intentionally separate from the native Ollama HTTP client. Credentials
-- AND request JSON travel only through an anonymous stdin pipe: no shell,
...
---@class AiRoseEndpoint
---@field scheme string
---@field authority string
---@field host string
---@field base string
---@field loopback boolean

-- Validate a provider endpoint base URL; returns the parsed endpoint or nil, err.
---@param url string
---@return AiRoseEndpoint? endpoint
---@return string? err
...
-- Validate a relative API path; returns true or nil, err.
---@param path string
---@return boolean? ok
---@return string? err
...
---@param entry table
---@param max_upload_bytes integer
---@return string? line
---@return string? err
...
local function request_prepare(opts)
    ...
    if endpoint.scheme ~= 'https' and not insecure_allowed then
        return nil, nil, 'provider transport requires HTTPS; only explicitly allowed loopback HTTP is supported'
    end
...
---@param opts table
---@param endpoint AiRoseEndpoint
---@param form_lines string[]?
...
---@param state table
---@param callback fun(err: string?, body: string?, info: table?)
---@param err string?
---@param body string?
...
---@param state table
---@param opts table
---@param response_bytes_max integer
---@param data string
---@return string? err
...
---@param config string curl config text
---@param on_stdout fun(err: string?, data: string?)
---@param on_exit fun(res: table)
---@return boolean ok
---@return any handle_or_err
...
---@class AiRoseTransportOptions
---@field endpoint string
---@field credential_host string
---@field path string
---@field method string?
...
---@field allow_insecure_local boolean?

---@param opts AiRoseTransportOptions
---@param callback fun(err: string?, body: string?, info: table?)
---@return table token
function M.request(opts, callback)
    ...
    if opts.output_path then
        local sink_error
        state.sink, sink_error = open_sink(opts.output_path, opts.max_output_bytes or response_bytes_max)
