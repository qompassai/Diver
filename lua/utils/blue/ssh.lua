#!/usr/bin/env lua
--- SSH helpers — small conveniences for remote work.
---
--- Plain-language version: SSH is how you securely reach other computers. This module holds small helpers used
--- around SSH workflows in this config. It is a helper library other modules call into.
---@module 'utils.blue.ssh'
