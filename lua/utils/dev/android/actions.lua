...
---@param args string[]
---@param opts? { show_output?: boolean, env?: table<string, string>, success?: string,
---  failure?: string, on_success?: fun(obj: vim.SystemCompleted) }
...
function M.start_emulator_picker()
    ...
    if avds == nil then
        notify(err or 'Failed to list emulators.', levels.ERROR, {})
        return
    end
