--- Salesforce Apex helpers — run and test Apex from Neovim.
---
--- Plain-language version: Apex is Salesforce's programming language. This module runs the current file or
--- selection, starts interactive sessions, tails logs, and runs test classes -- all through the Salesforce CLI. It
--- runs when you invoke its commands; it needs the `sf` CLI and a Salesforce org to talk to.
---@module 'utils.dev.sf.apex'
...
---Run the Apex code in the current buffer via the CLI.
---@return nil
...
---Run the visually selected Apex code.
---@return nil
...
---Open an interactive Apex REPL session.
---@return nil
