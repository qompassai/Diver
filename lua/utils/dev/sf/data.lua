--- Salesforce data helpers — query and edit org data from Neovim.
---
--- Plain-language version: this module talks to your Salesforce org's data: run SOQL queries, create/update/delete
--- records, import and export -- with results shown in Neovim buffers. It runs when you invoke its commands; it
--- needs the `sf` CLI and a connected org.
---@module 'utils.dev.sf.data'
...
---Run the SOQL query in the current buffer.
---@return nil
...
---Run the SOQL in the current file.
---@return nil
