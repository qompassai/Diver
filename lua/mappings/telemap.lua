...
map("n", "<leader>tz", "<cmd>Telescope zoxide list<CR>", vim.tbl_extend("force", opts, { desc = "Telescope Zoxide List" }))
...
map("n", "<leader>zs", "<cmd>:Telescope zoxide list<CR><C-s>", vim.tbl_extend("force", opts, { desc = "Zoxide split window" }))
-- In normal mode, press 'Space' + 'z' + 's' to open selected directory in split

-- Zoxide: Open in vertical split
map("n", "<leader>zv", "<cmd>:Telescope zoxide list<CR><C-v>", vim.tbl_extend("force", opts, { desc = "Zoxide vertical split" }))
...
map("n", "<leader>zli", "<cmd>:Lzi<CR>", vim.tbl_extend("force", opts, { desc = "Zoxide interactive local to window" }))
