...
function M.setup()
	...
	map("n", "<tab>", "<cmd>BufferLineCycleNext<CR>", vim.tbl_extend("force", opts, { desc = "buffer goto next" }))
	...
	map(
		...
		vim.tbl_extend("force", opts, { desc = "TS Expand Selection Incrementally" })
	)
	...
	map(
		...
		vim.tbl_extend("force", opts, { desc = "TS Incrementally Shrink Selection" })
	)
	...
	map(
		...
		vim.tbl_extend("force", opts, { desc = "TS Expand Selection to Next Larger Code Block" })
	)
	...
	map(
		...
		vim.tbl_extend("force", opts, { desc = "TS Navigate to Next Function Start" })
	)
	...
	map(
		...
		"<leader>tu",
		":TSShowCaptures<CR>",
		vim.tbl_extend("force", opts, { desc = "TS Show Syntax Info Under Cursor" })
	)
