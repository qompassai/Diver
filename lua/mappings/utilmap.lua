...
if ok then
	vim.keymap.set('n', '<leader>?', function()
		...
		desc = 'Keymap cheatsheet (fzf-lua)',
		silent = true,
		noremap = true,
	})
end
...
local function setup_spell_mappings()
	...
	if ok_utils and utils and utils.spell and utils.spell.add_from_dictionary then
		map('n', '<leader>wa', function()
			utils.spell.add_from_dictionary()
		end, 'Add word from custom dictionary to spellfile')
	end
	map('n', '<leader>wg', 'zg', 'Add word under cursor to spellfile')
end
