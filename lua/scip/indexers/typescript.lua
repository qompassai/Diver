...
---Return whether a project contains a TypeScript or JavaScript configuration.                                                                        ---@param root string Project root.
---@return boolean                                                         local function has_tsconfig(root)
...
---@return boolean                                                         local function has_pnpm_workspace(root)
        return utils.path_exists(
