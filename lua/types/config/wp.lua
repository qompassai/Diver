...
---   rules: WPJsonObject,
---   props: WPProperties,
---   cb: fun(action: string, value: WPJsonObject)
---)
...
---@field connect                                     fun(self: WPObjectManager, signal: string, cb: fun(om: WPObjectManager, obj: WPObject))
...
---@field id                                          integer
---@field properties                                  WPProperties
--- Registers active session item in the WirePlumber graph
...
--- Session item constructor; creates a new WirePlumber session item of the given type.
...
--- WirePlumber policy Utility helpers
---@class WPUtils
---@field cam_data                                    WPCameraData[]
---@field cam_source                                  WPGSource|nil
--- Returns whether properties can link to target
---@field canLink                                     fun(self: WPUtils, si_props: WPProperties, target: WPSessionItem): boolean
--- Checks passthrough compatibility; returns (compatible, can_passthrough)
...
---@field get_application_name                        fun(): string
...
--- Returns the default linkable for a session item, or nil.
...
--- Returns true if `target` is a role-policy target for `si_props`.
...
---@field parseBool                                   fun(var: any): boolean
...
--- Sends a client-visible error for a node.
---@field sendClientError                             fun(event: WPEvent, node: WPNode|WPObject|nil, code: integer, msg: string)
---@field set_audio_group                             fun(node: any, group: string|nil)
---@field unwrap_select_target_event                  fun(self: WPUtils, event: WPEvent): WPObject, WPSessionItemManager, WPSessionItem, WPProperties, table, WPSessionItem|nil
--- Updates priority metadata for a media-role-based link
