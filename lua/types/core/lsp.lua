...
---@field apex.enable_completion_statistics?               boolean
---@field apex.enable_semantic_errors?                     boolean
---@field apex.diagnostics?                                table
---@field apex.diagnostics.severity?                       'all'|'warning'|'error'
---@field apex.diagnostics.enableSemantic?                 boolean
---@field apex.restartBehavior?                            'prompt'|'restart'|'reset'
---@field apex.jvm?                                        table
---@field apex.jvm.maxHeap?                                string
---@field apex.jvm.debugInternalErrors?                    boolean
---@field apex.jvm.debugSemanticErrors?                    boolean
---@field apex.jvm.completionStatistics?                   boolean
---@field apex.jvm.disableLwcTypeGeneration?               boolean
---@field apex_ls.apexJarPath?                             string
---@field apex_ls.javaHome?                                string
---@field apex_ls.enableSObjectRefreshOnStartup?           boolean
---@field apex_ls.projectRootMarkers?                      string[]
